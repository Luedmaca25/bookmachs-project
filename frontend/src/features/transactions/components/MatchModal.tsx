      ...
      <div className="modal-card match-modal-card match-modal-card-custom">
        ...
        <div className="checkout-step-header">
          ...
          <h3 className="match-modal-title">
            Intercambia libros quiere intercambiar contigo
          </h3>
        ...
        <div className="duet-swap-deck duet-swap-deck-modal">
          ...
          <div className="swap-book-card target-card">
            ...
            <div className="swap-cover-frame swap-cover-frame-fixed">
              {book.imageUrl ? (
                <img 
                  ...
                  alt={book.title} 
                  onError={(e) => { e.currentTarget.src = 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=300'; }}
                />
              ) : (
            ...
            <div className="swap-book-author swap-book-author-sm">Autor: {book.author || 'Desconocido'}</div>
            <div className="mt-04">
                  ...
                  <div>
                    <div className="swap-cover-frame swap-cover-frame-fixed">
                      <img 
                        ...
                        onError={(e) => { e.currentTarget.src = 'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=300'; }} 
                      />
                    </div>
                    <div className="swap-book-title swap-book-title-sm">{currentOfferedBook.title}</div>
                    <div className="swap-book-author swap-book-author-sm">Autor: {currentOfferedBook.author || 'Desconocido'}</div>
                    <div className="mt-04">
