...
- [x] **Tarea 11:** Desarrollar interfaz del Panel CMS Web (Frontend Admin) para visualizar y editar configuraciones.
- [x] **Tarea 12:** Pruebas QA (Unitarias y E2E): Confirmar que la actualización de estas variables alteran el comportamiento del sistema en tiempo real.
...
- [x] **Tarea 20:** Desarrollar API para procesar la subida del libro creando la entidad en la base de datos con flag `IsExternalStock = true` y linkeando la imagen local.
...
- [x] **Tarea 37:** Integración Library-First (Backend): Instalar **Hangfire** y programar un Job (CRON) en background que devuelva el stock automáticamente y anule transacciones pasadas las 48 horas sin pago.
